...
export default function Footer() {
  return (
    <footer className="mt-24 border-t border-blue-200 bg-blue-50 py-10 text-sm">
      <div className="container grid gap-6 md:grid-cols-3">
        <div>
          <div className="font-bold text-blue-800 text-lg">Frahman & Brothers</div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600">
            ...
            <li><Link href="/supply-chain" className="hover:text-blue-700 transition-colors">Supply Chain</Link></li>
            <li><Link href="/contact" className="hover:text-blue-700 transition-colors">Contact</Link></li>
          </ul>
        </div>
      </div>
      <div className="container mt-6 text-gray-500 text-center border-t border-blue-200 pt-6">
